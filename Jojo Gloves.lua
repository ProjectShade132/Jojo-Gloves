...
function ORA()
	...
	DORA.Looped = true
	local Con1 = HitboxL.Touched:connect(function(hit) Damage(HitboxL, hit, 0, 0, 0, "Normal", RootPart, 0, "260430117", 1) end)
	local Con2 = HitboxR.Touched:connect(function(hit) Damage(HitboxR, hit, 0, 0, 0, "Normal", RootPart, 0, "260430117", 1) end)
			...
			if Effects[e] ~= nil then
				...
				if Thing ~= nil then
					...
					if Thing[2] == "Shoot" then
						...
						if hit ~= nil then
							Thing[3] = 0
							MagnitudeDamage(hit, 0, 0, 0, 0, "Normal", "161006093", 0.8)
